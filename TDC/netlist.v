...
// Date        : Thu Jul 23 12:01:49 2020
// Host        : DESKTOP-4AILNFN running 64-bit major release  (build 9200)
// Command     : write_verilog netlist.v
// Design      : TDC
  ...
  DSP48E1 #(
    ...
    \genblk1_0.DSP48E_BL 
       (.A({\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        ...
        .B({\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const1> }),
        ...
        .MULTSIGNIN(\<const0> ),
        .OPMODE({\<const0> ,\<const1> ,\<const0> ,\<const0> ,\<const0> ,\<const1> ,\<const1> }),
        .P(CNTR_OUT_INT),
...
module Counter
   (out_count_OBUF,
    clk_IBUF_BUFG,
    pipe_out,
    \genblk1[0].FDCE_inst_0 );
  output [47:0]out_count_OBUF;
  input clk_IBUF_BUFG;
  input [1:0]pipe_out;
  input [0:0]\genblk1[0].FDCE_inst_0 ;

  wire \<const1> ;
  wire clk_IBUF_BUFG;
  wire en;
  wire [0:0]\genblk1[0].FDCE_inst_0 ;
  wire [47:0]out_count_OBUF;
  wire [1:0]pipe_out;
  wire start_long;
  wire stop_long;
...
module StartPipeline
   (trigger,
    pipe_out,
    one_hot_start_OBUF,
    \genblk1[3].FDCE_inst_0 ,
    pipe_in,
    clk_IBUF_BUFG);
  output trigger;
  output [207:0]pipe_out;
  output [0:0]one_hot_start_OBUF;
  input \genblk1[3].FDCE_inst_0 ;
  input [207:0]pipe_in;
  input clk_IBUF_BUFG;
  ...
  wire \<const1> ;
  wire clk_IBUF_BUFG;
  wire \genblk1[3].FDCE_inst_0 ;
  wire [0:0]one_hot_start_OBUF;
  wire [207:0]pipe_in;
  wire [207:0]pipe_out;
  wire trigger;
  ...
  LUT5 #(
    .INIT(32'h00008000)) 
    \one_hot_start_OBUF[170]_inst_i_1 
       (.I0(pipe_out[173]),
        .I1(pipe_out[172]),
        .I2(pipe_out[170]),
        .I3(pipe_out[171]),
        .I4(pipe_out[174]),
        .O(one_hot_start_OBUF));
endmodule

module StartThermo2OneHot
   (one_hot_start_OBUF,
    pipe_out);
  output [202:0]one_hot_start_OBUF;
  input [207:0]pipe_out;

  wire [202:0]one_hot_start_OBUF;
  wire [207:0]pipe_out;
...
module StopThermo2OneHot
   (one_hot_stop_OBUF,
    pipe_out);
  output [175:0]one_hot_stop_OBUF;
  input [179:0]pipe_out;

  wire [175:0]one_hot_stop_OBUF;
  wire [179:0]pipe_out;
...
module TDC
  ...
  input clk;
  input hit;
  output [203:0]one_hot_start;
  output [175:0]one_hot_stop;
  output [47:0]out_count;

  wire \Start_pipeline.Start_pipeline_n_0 ;
  wire clk;
  wire clk_IBUF;
  wire clk_IBUF_BUFG;
  wire hit;
  ...
  StartPipeline \Start_pipeline.Start_pipeline 
       (.clk_IBUF_BUFG(clk_IBUF_BUFG),
        .\genblk1[3].FDCE_inst_0 (hit_IBUF),
        .one_hot_start_OBUF(one_hot_start_OBUF[170]),
        .pipe_in(thermo_start_raw),
        .pipe_out(thermo_start_piped),
        .trigger(\Start_pipeline.Start_pipeline_n_0 ));
  StartThermo2OneHot \Start_thermo2onehot.Start_thermo2onehot 
       (.one_hot_start_OBUF({one_hot_start_OBUF[203:171],one_hot_start_OBUF[169:0]}),
        .pipe_out(thermo_start_piped));
  ...
  StopThermo2OneHot \Stop_thermo2onehot.Stop_thermo2onehot 
       (.one_hot_stop_OBUF(one_hot_stop_OBUF),
        .pipe_out(thermo_stop_piped));
  ...
  Counter \counter.counter 
       (.clk_IBUF_BUFG(clk_IBUF_BUFG),
        .\genblk1[0].FDCE_inst_0 (thermo_start_piped[0]),
        .out_count_OBUF(out_count_OBUF),
        .pipe_out({thermo_stop_piped[179],thermo_stop_piped[0]}));
  IBUF hit_IBUF_inst
       (.I(hit),
        .O(hit_IBUF));
  ...
  OBUF \one_hot_start_OBUF[171]_inst 
       (.I(one_hot_start_OBUF[171]),
        .O(one_hot_start[171]));
  OBUF \one_hot_start_OBUF[172]_inst 
       (.I(one_hot_start_OBUF[172]),
        .O(one_hot_start[172]));
  OBUF \one_hot_start_OBUF[173]_inst 
       (.I(one_hot_start_OBUF[173]),
        .O(one_hot_start[173]));
  OBUF \one_hot_start_OBUF[174]_inst 
       (.I(one_hot_start_OBUF[174]),
        .O(one_hot_start[174]));
  OBUF \one_hot_start_OBUF[175]_inst 
       (.I(one_hot_start_OBUF[175]),
        .O(one_hot_start[175]));
  OBUF \one_hot_start_OBUF[176]_inst 
       (.I(one_hot_start_OBUF[176]),
        .O(one_hot_start[176]));
  OBUF \one_hot_start_OBUF[177]_inst 
       (.I(one_hot_start_OBUF[177]),
        .O(one_hot_start[177]));
  OBUF \one_hot_start_OBUF[178]_inst 
       (.I(one_hot_start_OBUF[178]),
        .O(one_hot_start[178]));
  OBUF \one_hot_start_OBUF[179]_inst 
       (.I(one_hot_start_OBUF[179]),
        .O(one_hot_start[179]));
  OBUF \one_hot_start_OBUF[17]_inst 
       (.I(one_hot_start_OBUF[17]),
        .O(one_hot_start[17]));
  OBUF \one_hot_start_OBUF[180]_inst 
       (.I(one_hot_start_OBUF[180]),
        .O(one_hot_start[180]));
  OBUF \one_hot_start_OBUF[181]_inst 
       (.I(one_hot_start_OBUF[181]),
        .O(one_hot_start[181]));
  OBUF \one_hot_start_OBUF[182]_inst 
       (.I(one_hot_start_OBUF[182]),
        .O(one_hot_start[182]));
  OBUF \one_hot_start_OBUF[183]_inst 
       (.I(one_hot_start_OBUF[183]),
        .O(one_hot_start[183]));
  OBUF \one_hot_start_OBUF[184]_inst 
       (.I(one_hot_start_OBUF[184]),
        .O(one_hot_start[184]));
  OBUF \one_hot_start_OBUF[185]_inst 
       (.I(one_hot_start_OBUF[185]),
        .O(one_hot_start[185]));
  OBUF \one_hot_start_OBUF[186]_inst 
       (.I(one_hot_start_OBUF[186]),
        .O(one_hot_start[186]));
  OBUF \one_hot_start_OBUF[187]_inst 
       (.I(one_hot_start_OBUF[187]),
        .O(one_hot_start[187]));
  OBUF \one_hot_start_OBUF[188]_inst 
       (.I(one_hot_start_OBUF[188]),
        .O(one_hot_start[188]));
  OBUF \one_hot_start_OBUF[189]_inst 
       (.I(one_hot_start_OBUF[189]),
        .O(one_hot_start[189]));
  OBUF \one_hot_start_OBUF[18]_inst 
       (.I(one_hot_start_OBUF[18]),
        .O(one_hot_start[18]));
  OBUF \one_hot_start_OBUF[190]_inst 
       (.I(one_hot_start_OBUF[190]),
        .O(one_hot_start[190]));
  OBUF \one_hot_start_OBUF[191]_inst 
       (.I(one_hot_start_OBUF[191]),
        .O(one_hot_start[191]));
  OBUF \one_hot_start_OBUF[192]_inst 
       (.I(one_hot_start_OBUF[192]),
        .O(one_hot_start[192]));
  OBUF \one_hot_start_OBUF[193]_inst 
       (.I(one_hot_start_OBUF[193]),
        .O(one_hot_start[193]));
  OBUF \one_hot_start_OBUF[194]_inst 
       (.I(one_hot_start_OBUF[194]),
        .O(one_hot_start[194]));
  OBUF \one_hot_start_OBUF[195]_inst 
       (.I(one_hot_start_OBUF[195]),
        .O(one_hot_start[195]));
  OBUF \one_hot_start_OBUF[196]_inst 
       (.I(one_hot_start_OBUF[196]),
        .O(one_hot_start[196]));
  OBUF \one_hot_start_OBUF[197]_inst 
       (.I(one_hot_start_OBUF[197]),
        .O(one_hot_start[197]));
  OBUF \one_hot_start_OBUF[198]_inst 
       (.I(one_hot_start_OBUF[198]),
        .O(one_hot_start[198]));
  OBUF \one_hot_start_OBUF[199]_inst 
       (.I(one_hot_start_OBUF[199]),
        .O(one_hot_start[199]));
  ...
  OBUF \one_hot_start_OBUF[1]_inst 
       (.I(one_hot_start_OBUF[1]),
        .O(one_hot_start[1]));
  OBUF \one_hot_start_OBUF[200]_inst 
       (.I(one_hot_start_OBUF[200]),
        .O(one_hot_start[200]));
  OBUF \one_hot_start_OBUF[201]_inst 
       (.I(one_hot_start_OBUF[201]),
        .O(one_hot_start[201]));
  OBUF \one_hot_start_OBUF[202]_inst 
       (.I(one_hot_start_OBUF[202]),
        .O(one_hot_start[202]));
  OBUF \one_hot_start_OBUF[203]_inst 
       (.I(one_hot_start_OBUF[203]),
        .O(one_hot_start[203]));
  ...
  OBUF \one_hot_stop_OBUF[171]_inst 
       (.I(one_hot_stop_OBUF[171]),
        .O(one_hot_stop[171]));
  OBUF \one_hot_stop_OBUF[172]_inst 
       (.I(one_hot_stop_OBUF[172]),
        .O(one_hot_stop[172]));
  OBUF \one_hot_stop_OBUF[173]_inst 
       (.I(one_hot_stop_OBUF[173]),
        .O(one_hot_stop[173]));
  OBUF \one_hot_stop_OBUF[174]_inst 
       (.I(one_hot_stop_OBUF[174]),
        .O(one_hot_stop[174]));
  OBUF \one_hot_stop_OBUF[175]_inst 
       (.I(one_hot_stop_OBUF[175]),
        .O(one_hot_stop[175]));
